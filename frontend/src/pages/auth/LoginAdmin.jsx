    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400 font-medium">
          {t('auth.adminLoginSubtitle') || 'Sign in to access admin console'}
        </p>
      </div>
      ...
      <form className="space-y-5" onSubmit={handleLogin}>
        ...
        <p className="text-center text-xs text-gray-400 dark:text-gray-500 font-semibold uppercase tracking-wider select-none pt-2">
          Administrator Gateway Only
        </p>
